...
export class initialMigration1667221589793 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`CREATE TABLE "reviews" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "review_text" character varying NOT NULL, "stars" integer NOT NULL, CONSTRAINT "PK_231ae565c273ee700b283f15c1d" PRIMARY KEY ("id"))`
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`ALTER TABLE "users" ADD CONSTRAINT "FK_23a005c946a1abf3d8dc4b94bcb" FOREIGN KEY ("reviewId") REFERENCES "reviews"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
		);
		await queryRunner.query(
	...
	public async down(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`ALTER TABLE "users" DROP CONSTRAINT "FK_23a005c946a1abf3d8dc4b94bcb"`
		);
		await queryRunner.query(
