...
export class initialMigration1667223978634 implements MigrationInterface {
    name = 'initialMigration1667223978634'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "services" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying NOT NULL, "price" numeric(8,2) NOT NULL, CONSTRAINT "UQ_019d74f7abcdcb5a0113010cb03" UNIQUE ("name"), CONSTRAINT "PK_ba2d347a3168a296416c6c5ccb2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "reservation_services" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "amount" integer NOT NULL, "reservationId" uuid, "serviceId" uuid, CONSTRAINT "PK_4f6633abeabcab5b1c5c4288f19" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "reviews" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "review_text" character varying NOT NULL, "stars" integer NOT NULL, CONSTRAINT "PK_231ae565c273ee700b283f15c1d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(120) NOT NULL, "password" character varying NOT NULL, "email" character varying(120) NOT NULL, "is_adm" boolean NOT NULL DEFAULT false, "cpf" character varying, "profile_img" character varying, "reviewId" uuid, CONSTRAINT "REL_23a005c946a1abf3d8dc4b94bc" UNIQUE ("reviewId"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "reservations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "checkin" TIMESTAMP NOT NULL, "checkout" TIMESTAMP NOT NULL, "status" character varying NOT NULL DEFAULT 'reserved', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, CONSTRAINT "PK_da95cef71b617ac35dc5bcda243" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "rooms" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "roomTypeId" uuid, CONSTRAINT "PK_0368a2d7c215f2d0458a54933f2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "reservation_pets" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "petId" uuid, "reservationId" uuid, "roomId" uuid, CONSTRAINT "PK_84a706499b4feb56a255abe64b0" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "reservation_services" ADD CONSTRAINT "FK_979cfbd7a5e4170cc36e987d940" FOREIGN KEY ("serviceId") REFERENCES "services"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_23a005c946a1abf3d8dc4b94bcb" FOREIGN KEY ("reviewId") REFERENCES "reviews"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "reservation_pets" ADD CONSTRAINT "FK_aecbeebe0f6bf3c4d92364fa87a" FOREIGN KEY ("petId") REFERENCES "pets"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "reservation_pets" ADD CONSTRAINT "FK_0ffb69aca901348c9c776ec18ac" FOREIGN KEY ("roomId") REFERENCES "rooms"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "reservation_pets" DROP CONSTRAINT "FK_0ffb69aca901348c9c776ec18ac"`);
        await queryRunner.query(`ALTER TABLE "reservation_pets" DROP CONSTRAINT "FK_81a820f2774398377ae38d9ab12"`);
        await queryRunner.query(`ALTER TABLE "reservation_pets" DROP CONSTRAINT "FK_aecbeebe0f6bf3c4d92364fa87a"`);
        ...
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "FK_23a005c946a1abf3d8dc4b94bcb"`);
        await queryRunner.query(`ALTER TABLE "reservation_services" DROP CONSTRAINT "FK_979cfbd7a5e4170cc36e987d940"`);
